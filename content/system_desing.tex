...
\begin{figure}[H]
	...
	\caption{Display 2.3.4 b1 szoftver kezdőképernyője (WPC)}\label{fig:display_wpc_0}
\end{figure}
%----------------------------------------------------------------------------
...
\begin{figure}[H]
	...
	\caption{Display 2.3.4 b1 szoftver fő kezelőfelülete (WPC)}\label{fig:display_wpc_0_1}
\end{figure}
%----------------------------------------------------------------------------
...
Bármely változtatás kardinálisan más eredményt fog eredményezni. A tervezési folyamatot újra kell kezdeni, ellenkező esetben
...
\begin{figure}[H]
	...
	\caption{Display 2.3.4 b1 szoftver exportáló kezelőfelülete (WPC)}\label{fig:display_wpc_7}
\end{figure}
%----------------------------------------------------------------------------

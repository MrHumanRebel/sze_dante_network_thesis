...
átviteli formátumoktól (AES/EBU vagy MADI) az IP-alapú szabványok felé
(AES67). Ez a csomag alapú hálózati megoldás hatalmas rugalmasságot
...
Dante a `Digital Audio Network Through Ethernet'. A Dante sok jelentős
...
profitál, több száz gyártó által gyártott több ezer eszközzel. 
...
Az AVB-t a gyártók fejlesztőcsoportja, az AVnu Alliance időérzékeny hálózat (TSN - Time Sensitive Network) néven nevezte el.
...
minden felhasználójuk számára egyidejű használat esetén is. 
...
építeni amelyek elegendő sávszélességgel, és kizárólag az audio alkalmazások számára legyenek
használatosak, tehát ne keveredjenek általános mindennapi alkalmazásokkal. 

%----------------------------------------------------------------------------

A legtöbb audio-over-IP technológia abból indul ki, hogy az alapját szolgáló
...
%----------------------------------------------------------------------------
A legtöbb audio alkalmazásban kritikus több eszköz szinkronizált viselkedése.
Elengedhetetlen a mikrofonok és hangszórók közötti fázispontosság.
...
módszert kell biztosítani. Ez egy fontos, és egyben új probléma a audio hálózatokban, amellyel az összes

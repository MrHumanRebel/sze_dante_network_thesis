...
\begin {figure}[H]
    \centering
	\includegraphics[width=250px]{figures/wpc_deployed.jpg}
...
\begin {figure}[H]
	\centering
	\includegraphics[width=300px]{figures/system_deployed.jpg}
...
\end{figure}
%----------------------------------------------------------------------------
A ME-500 személyi keverőegység az előadók számára készült,
lehetővé téve, hogy egyéni igényeik szerint keverhessék a monitorozott
hangsávokat. Az egység egyszerű és intuitív felhasználói felülettel 
rendelkezik, amelyet úgy terveztek, hogy a zenészek, akár minimális
technikai tudással is, gyorsan megtanulhassák a használatát. 
A rendszer további előnye, hogy könnyedén integrálható 
már meglévő audió hálózatokba, ami széleskörű kompatibilitást biztosít.
%----------------------------------------------------------------------------
\begin
    {figure}[H]
    \centering

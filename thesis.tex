...
% Képek és ábrák képaláírásai (objektum alatt)
\captionsetup[figure]{position=below}

% Táblázatok és kódrészletek képaláírásai (objektum felett)
\captionsetup[table]{position=above}
\captionsetup[lstlisting]{position=above}

% Példa betűtípus módosításra (Times New Roman)
\renewcommand{\rmdefault}{ptm}

% Kódrészlet környezet konfigurálása
\lstset{
  basicstyle=\ttfamily\small, % Alap betűtípus
  captionpos=t, % Képaláírás fent
  frame=single, % Keret
  numbers=left, % Sorok számozása
  numberstyle=\tiny
}
